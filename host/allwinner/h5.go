...
var mappingH5 = map[string][5]pin.Func{
	...
	"PD0":  {"RGMII_RXD3/MII_RXD3/RMII_NULL", "DI_TX", "TS2_CLK"},
	"PD1":  {"RGMII_RXD2/MII_RXD2/RMII_NULL", "DI_RX", "TS2_ERR"},
	"PD2":  {"RGMII_RXD1/MII_RXD1/RMII_RXD1", "", "TS2_SYNC"},
	"PD3":  {"RGMII_RXD0/MII_RXD0/RMII_RXD0", "", "TS2_DVLD"},
	"PD4":  {"RGMII_RXCK/MII_RXCK/RMII_NULL", "", "TS2_D0"},
	"PD5":  {"RGMII_RXCTL/MII_RXDV/RMII_CRS_DV", "", "TS2_D1"},
	"PD6":  {"RGMII_NULL/MII_RXERR/RMII_RXER", "", "TS2_D2"},
	"PD7":  {"RGMII_TXD3/MII_TXD3/RMII_NULL", "", "TS2_D3", "TS3_CLK"},
	"PD8":  {"RGMII_TXD2/MII_TXD2/RMII_NULL", "", "TS2_D4", "TS3_ERR"},
	"PD9":  {"RGMII_TXD1/MII_TXD1/RMII_TXD1", "", "TS2_D5", "TS3_SYNC"},
	"PD10": {"RGMII_TXD0/MII_TXD0/RMII_TXD0", "", "TS2_D6", "TS3_DVLD"},
	"PD11": {"RGMII_NULL/MII_CRS/RMII_NULL", "", "TS2_D7", "TS3_D0"},
	"PD12": {"RGMII_TXCK/MII_TXCK/RMII_TXCK", "", "SIM1_PWREN"},
	"PD13": {"RGMII_TXCTL/MII_TXEN/RMII_TXEN", "", "SIM1_CLK"},
	"PD14": {"RGMII_NULL/MII_TXERR/RMII_NULL", "", "SIM1_DATA"},
	"PD15": {"RGMII_CLKIN/MII_COL/RMII_NULL", "", "SIM1_RST"},
	"PD16": {"MDC", "", "SIM1_DET"},
	"PD17": {"MDIO"},
